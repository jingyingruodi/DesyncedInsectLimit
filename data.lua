...
function package:init()
	print("[InsectLimit] Initializing adjusted swarm logic...")
	...
	print("[InsectLimit] Logic override successful. Cap: 30000, Expansion: 10000, Throttle: 3000.")
end
